...
func TestIdentities(t *testing.T) {
	commonName := "TEST_IDENTITY_" + uuid.New().String()
	...
	identity := getIdentityByCommonName(t, ids, commonName)
...
func TestMacIdentity_Equal(t *testing.T) {
	...
	identity1 := getIdentityByCommonName(t, ids, commonName1)
	require.NotNil(t, identity1)
	identity2 := getIdentityByCommonName(t, ids, commonName2)
